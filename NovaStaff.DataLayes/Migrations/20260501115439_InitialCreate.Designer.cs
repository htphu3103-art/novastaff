...
namespace NovaStaff.DataLayers.Migrations
{
    ...
    [Migration("20260501115439_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NovaStaff.Models.Entities.LeaveRequest", b =>
                {
                    ...
                    b.ToTable("LeaveRequests", null, t =>
                        {
                            t.HasCheckConstraint("CK_LeaveRequest_ApprovedBy", "ApprovedBy IS NULL OR Status IN (1, 2)");

                            t.HasCheckConstraint("CK_LeaveRequest_ApprovedDate", "ApprovedDate IS NULL OR Status IN (1, 2)");
                    ...
                    b.ToTable("PayrollDetails", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_PayrollDetail_PaidDate", "PaidDate IS NULL OR Status = 2");
